...
func main() {
	...
	// case when you'd like to find data between cache and dabatase and want to get the first and data faster
	select {
	case a = <-x:
...
func generateValue(c chan int, limit chan int) chan int {
	limit <- 1
